# Putting our picture back into Minecraft

# First install some software. Type this command in a Terminal
# sudo apt-get install python3-skimage
# Make sure you save colour_map.png to the same place as your Mu code
